...
public class Decoration2Script : Decor
{
    ...
    private void Start()
    {
        this.gameObject.GetComponent<Renderer>().material.color = InputData.Instance.decor2;
        this.gameObject.transform.localScale = Vector3.one * InputData.Instance.Scale_decor2;
